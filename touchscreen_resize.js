	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			touchMaxStimulusWidth : '25%', 
			touchMaxStimulusHeight : '25%', 
		...
		*/
		...
		API.addStimulusSets({
			...
			touchInputStimuli: [
				{media:{html:'<div></div>'}, size:{height:35,width:30},css:{background:'#00FF00', opacity:0.3, zindex:-1}, location:{right:0}, data:{handle:'right'}},
				{media:{html:'<div></div>'}, size:{height:35,width:30},css:{background:'#00FF00', opacity:0.3, zindex:-1}, location:{left:0}, data:{handle:'left'}}
			]
		});
