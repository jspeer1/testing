	...
	function iatExtension(options)
	{
		...
		*/
		...
		API.addStimulusSets({
			...
			touchInputStimuli: [
				{media:{html:'<div></div>'}, size:{height:24,width:15},css:{background:'#00FF00', opacity:0.3, zindex:-1}, location:{right:0}, data:{handle:'right'}},
				{media:{html:'<div></div>'}, size:{height:24,width:15},css:{background:'#00FF00', opacity:0.3, zindex:-1}, location:{left:0}, data:{handle:'left'}}
			]
		});
